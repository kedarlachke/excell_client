...
import {ActionToDispatch,ActionToRedirect,handleSignUp,checkCurrentUsername} from '../../actions'
...
//import  '../commoncomponents/validationlib';
//
class Signup extends Component {
  constructor(props) {
    ...
    this.state={
      ...
      handleSignUp(values,async (err,result)=>
      {
        if(!err)
        {
          if(!result)
