...
import ContractGeneric from '../Contract/ContractGeneric_View';              //..Contract                    //..Client
    ...
    async  componentDidMount() {
        ...
        if (this.props.location.state) {
            ...
            if (this.state.SERVICETYP == 'Asset Search') {
                await this.setState({ SERVICETYP: "ASSET_SEARCH", DispalyComp: !this.state.DispalyComp, });

            }
            if (this.state.SERVICETYP == 'Child Custody') {
                await this.setState({ SERVICETYP: "CHILD_CUSTODY", DispalyComp: !this.state.DispalyComp, });
            }
            if (this.state.SERVICETYP == 'Infidelity') {
                await this.setState({ SERVICETYP: "INFIDELITY", DispalyComp: !this.state.DispalyComp, });
            }


            if (this.state.SERVICETYP == 'Other Cases') {
                await this.setState({ SERVICETYP: "OTHER_CASE", DispalyComp: !this.state.DispalyComp, });
            }

            if (this.state.SERVICETYP == 'Locate People') {
                await this.setState({ SERVICETYP: "LOCATE_PEOPLE", DispalyComp: !this.state.DispalyComp, });
            }

            if (this.state.SERVICETYP == 'Workers Comp') {
                await this.setState({ SERVICETYP: "WORKERS_COMP", DispalyComp: !this.state.DispalyComp, });
            }


            if (this.state.SERVICETYP == 'Process Server') {
                await this.setState({ SERVICETYP: "PROCESS_SERVER", DispalyComp: !this.state.DispalyComp, });
            }
                    ...
                    <div className="fourteen wide computer fourteen wide tablet fourteen wide mobile column">
                        <Tabs selectedIndex={this.state.tabIndex} onSelect={tabIndex => this.setState({ tabIndex })} >
                            ...
                            <TabPanel>
                                ...
                                {
                                    this.state.Case_Typ ? <CaseGeneric_View showMsg={this.showMsg} isCust={true} Case_Id={this.state.Case_Id} caseType={this.state.Case_Typ} gotoCaseType={this.gotoCaseType} gotoPreviousTab={this.gotoPreviousTab} CLIENTID={this.state.CLIENTID} history={this.props.history} /> : null
                                }

                                {
                                    this.state.SERVICETYP ? <CaseGeneric_View showMsg={this.showMsg} isCust={true} caseType={this.state.SERVICETYP} Case_Id={this.state.Case_Id} gotoCaseType={this.gotoCaseType} gotoPreviousTab={this.gotoPreviousTab} data={this.props.location.state.data.CIDSYS} CLIENTID={this.state.CLIENTID} history={this.props.history} /> : null
                                }
                            </TabPanel>
                            ...
                            <TabPanel>
                                ...
                                {
                                    this.state.OnClickAuthbtn == 'eCheck Authorization' ? <ECheckAuthorization isCust={true} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} Client_Name={this.state.Client_Name} CLIENTID={this.state.CLIENTID} history={this.props.history} /> :
                                        this.state.OnClickAuthbtn == 'Card Authorization' ? <CardAuthorization isCust={true} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} Client_Name={this.state.Client_Name} CLIENTID={this.state.CLIENTID} history={this.props.history} /> :
                                            this.state.OnClickAuthbtn == 'Cash/Other' ? <OtherAuthorization isCust={true} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} Client_Name={this.state.Client_Name} CLIENTID={this.state.CLIENTID} history={this.props.history} /> : null
                                }

                                {
                                    this.state.Auth_Typ == 'Check' ? <ECheckAuthorization isCust={true} data={this.state.Auth_Data} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} CLIENTID={this.state.CLIENTID} history={this.props.history} /> :
                                        this.state.Auth_Typ == 'Card' ? <CardAuthorization isCust={true} data={this.state.Auth_Data} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} CLIENTID={this.state.CLIENTID} history={this.props.history} /> :
                                            this.state.Auth_Typ == 'Cash' ? <OtherAuthorization isCust={true} data={this.state.Auth_Data} Case_Id={this.state.Case_Id} showMsg={this.showMsg} gotoPreviousTab={this.gotoPreviousTab} CLIENTID={this.state.CLIENTID} history={this.props.history} /> : null
                                }
                            ...
                            <TabPanel>
                                ...
                                <ProgressReport Case_Id={this.state.Case_Id} isCust={true} history={this.props.history} />
                            ...
                            <TabPanel>
                                ...
                                <Invoice Case_Id={this.state.Case_Id} isCust={true} history={this.props.history} />
