                ...
                <div>
                    ...
                    <div className="modal" style={{ display: this.state.showMailPopup }} >
                        <div className="modal-content">
                            ...
                            <Lead_Mail LeadId={this.props.location.state.data.CID}  MailFrom={this.props.location.state.data.EMAILID} closeMailPopup={this.closeMailPopup} showMsg={this.showMsg} />
                        </div>
                    </div>
