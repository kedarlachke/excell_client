                    ...
                    <div className="ui segment" >
                        <div className="ui form">
                            ...
                            <div className="row" style={{marginLeft: "0px"}} >
                        	   ...
                        	   <br/> <br/><strong>CLIENT</strong> agrees to pay a retainer for services of Excell Investigations or its agents the sum of <strong>$</strong><input id="TOTAL" value={this.state.TOTAL}  onChange={(e)=>this.setState({TOTAL:e.target.value})} style={{width:"10%"}} /> <label id="errorspan">{this.state.errorTOTAL}</label>, the Hourly rate shall be <strong>$</strong><input id="RATEPERH" value={this.state.RATEPERH}  onChange={(e)=>this.setState({RATEPERH:e.target.value})} style={{width:"10%"}} /><label id="errorspan" >{this.state.errorRATEPERH?this.state.errorRATEPERH:null}</label> per hour, plus <strong>$</strong><input id="RATEPERM" value={this.state.RATEPERM} onChange={(e)=>this.setState({RATEPERM:e.target.value})} style={{width:"10%"}}/> <label id="errorspan">{this.state.errorRATEPERM?this.state.errorRATEPERM:null}</label> per mile.plus actual costs and out-of-pocket expenses. (Unless agreed otherwise in the underline clause below) 
