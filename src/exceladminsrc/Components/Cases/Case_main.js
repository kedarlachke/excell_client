                         ...
                         <div className="one wide computer one wide tablet one wide mobile column">
                            ...
                            <div className="fourteen wide computer fourteen wide tablet fourteen wide mobile column">
                                ...
                                <div className="icode" id="title_header">
                                    ...
                                    <a href={this.exportCaseExcel()} style={{ color: '#151515' }}>   <i id="iconbar" className="arrow down icon"></i></a>
                                    ...
                                    <div className="ui form">
                                            ...
                                            columns={[
...

                                                {
                                                    ...
                                                    Cell: row => (
                                                       ...
                                                       {/*----button View---------- */}
                                                       <Link to={{ pathname: '/viewcase', state: { data: row.original } }}>
                                                                <div id="griddeletebutton" className="ui  button" tabIndex="0" >
                                                                    <i id="gridicon" className="eye  icon"></i>
                                                                </div>
                                                            </Link >
                                                            {/*----button tasks(opens task_add form)---------- */}
                                                            <Link to={{ pathname: "/addtask", state: { taskofid: row.original.CIDSYS, taskof: "Case", TaskType: "AssignedTask", } }}>
                                                            ...
                                                            {/*----button Mail---------- */}
                                                            <div id="griddeletebutton" className="ui blue button" tabIndex="0" onClick={() => this.setState({ showMailPopup: 'flex', CIDSYS: row.original.CIDSYS, MailFrom: row.original.EMAILID,FULLNM: row.original.FRSTNM })}>
                                                    ...
                                                    <div style={{ padding: "10px" }}>
                                                        <div className="ui list">
                                                            <div className="item" style={{ marginLeft: 5 }}>
                                                                ...
                                                                <div style={{ float: 'left',paddingTop: 5 }}> <strong>Contact Mode :</strong>  <span>{rowData.MODDESC}</span>  </div>
                                                                <div style={{ marginLeft: 330, paddingTop: 5 }}>  <strong >Note:</strong>  {rowData.ADDCOMMETS && rowData.ADDCOMMETS.includes("<p>")==true?<span>{"Mail Sent"}</span>:<span>{rowData.ADDCOMMETS}</span>}</div>
                                        ...
                                        <div className="modal" style={{ display: this.state.showModal }} >
                                            <div className="modal-content">
                                                ...
                                                <p style={{ color: "white" }}> 	Are you sure you want to delete this Case ?</p>
                                        ...
                                        <div className="modal" style={{ display: this.state.showMailPopup }} >
                                            <div className="modal-content">
                                                <Lead_Mail LeadId={this.state.CIDSYS} MailFor="Case" FULLNM={this.state.FULLNM} closeMailPopup={this.closeMailPopup} MailFrom={this.state.MailFrom} showMsg={this.showMsg} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
