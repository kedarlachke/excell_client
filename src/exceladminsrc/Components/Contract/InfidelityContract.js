                    ...
                    <div className="ui segment" >
                        <div className="ui form">
                        	...
                        	<div className="row" style={{marginLeft: "0px"}} >
                        		 ...
                        		 <br/><input id="FULLNM" value={this.state.FULLNM} onChange={(e)=>this.setState({FULLNM:e.target.value})} style={{width:"20%"}}/> <label id="errorspan" >{this.state.errorFULLNM}</label>, hereinafter referred to as “CLIENT” DOES hereby agree to retain the services of Excel Investigation, a private investigative agency, duly licensed under the laws of the state of California, which maintains its offices at 8105 East 2nd Street, Downey, CA, for the purpose of performing the following investigative work: 
                        	    ...
                        	    <br/><br/><strong>CLIENT</strong> agrees to pay a retainer for services of Excell Investigations or its agents the sum of <strong>$</strong><input id="TOTAL"  value={this.state.TOTAL}  onChange={(e)=>this.setState({TOTAL:e.target.value})} style={{width:"10%"}} /> <label id="errorspan" className="" >{this.state.errorTOTAL}</label>, the hourly rate shall be<br/><br/> <strong>$</strong><input id="RATEPERH" value={this.state.RATEPERH} onChange={(e)=>this.setState({RATEPERH:e.target.value})} style={{width:"10%"}}/> <label id="errorspan" className="" >{this.state.errorRATEPERH}</label> per hour for a maximum of <input id="RATEPERM" value={this.state.RATEPERM} onChange={(e)=>this.setState({RATEPERM:e.target.value})} style={{width:"10%"}} /><label id="errorspan">{this.state.errorRATEPERM}</label> <strong>hours</strong> of surveillance plus <strong>$</strong><input id="MAXH" value={this.state.MAX} onChange={(e)=>this.setState({MAX:e.target.value})} style={{width:"10%"}} /><label id="errorspan" >{this.state.errorMAX}</label>. The balance shall be due payable upon of case completion. 
