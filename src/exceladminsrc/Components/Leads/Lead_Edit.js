                ...
                <div>
                                ...
                                <div className="fourteen wide computer fourteen wide tablet fourteen wide mobile column">
                                    <div className="ui two column stackable grid">
                                        ...
                                        <div className=" row" style={{ paddingBottom: 10, marginTop: 10 }}>
                                            ...
                                            {/* <Link to={{ pathname: "/tasks/Task_Form", state: { taskofid: this.props.location.state.data.CID, taskof: "Lead", TaskType: "AssignedTask", } }}>
                                            ...
                                            <div className="three wide column" style={{ textAlign: 'right', paddingRight: 0 }}>
                                                {/*----button tasks(opens task_add form)---------- */}
                                                            ...
                                                            <div className="seven wide column">
                                                                <div className="field">
                                                                    ...
                                                                    <select className="" value={this.state.Status} onChange={e => this.setState({ Status: e.target.value })}
                                                                        ...
                                                                        <option value="05">Completed</option>
                                                                        <option value="04">Converted</option>
                    ...
                    <div className="modal" style={{ display: this.state.showMailPopup }} >
                        <div className="modal-content">
                            ...
                            <Lead_Mail LeadId={this.props.location.state.data.CID} FULLNM={this.props.location.state.data.FULLNM} MailFrom={this.props.location.state.data.EMAILID} closeMailPopup={this.closeMailPopup} showMsg={this.showMsg} />
                        </div>
                    </div>
                    ...
                    <div className="modal" style={{ display: this.state.showTaskPopup}} >
                        <div className="modal-content">
                            ...
                            <Task_Add taskofid={this.props.location.state.data.CID} taskof={"Lead"}
