...
export default class processContract extends Component {
                    ...
                    <div className="ui segment" >
                        <div className="ui form">
                            ...
                            <div className="row" style={{marginLeft: "0px"}} >
                        	    ...
                        	    <br/><br/><strong>CLIENT</strong> agrees to pay a retainer for services of Excel Investigations or its agents the sum of <strong>$</strong><input id="TOTAL" value={this.state.TOTAL} onChange={(e)=>this.setState({TOTAL:e.target.value})}  style={{width:"10%"}}/>  <label id="errspanTOTAL" className="" style={{color:this.state.errorTOTAL?'#dd212d':null}}>{this.state.errorTOTAL?this.state.errorTOTAL:null}</label>, the Hourly rate shall be <strong>$</strong><input id="RATEPERH" style={{width:"10%"}} value={this.state.RATEPERH} onChange={(e)=>this.setState({RATEPERH:e.target.value})} /><label id="errspanRATEPERH" className="" style={{color:this.state.errorRATEPERH?'#dd212d':null}}>{this.state.errorRATEPERH?this.state.errorRATEPERH:null}</label> per hour, plus <strong>$</strong><input id="RATEPERM" value={this.state.RATEPERM} onChange={(e)=>this.setState({RATEPERM:e.target.value})}  style={{width:"10%"}} /><label id="errspanRATEPERM" className="" style={{color:this.state.errorRATEPERM?'#dd212d':null}}>{this.state.errorRATEPERM?this.state.errorRATEPERM:null}</label> per mile. In the event it becomes necessary for an investigator to testify at deposition or in court, <strong>Excel Investigations </strong>shall be compensated an hourly rate for such time, including such actual travel time with a minimum of 5 hours chargeable (unless agreed otherwise in the underline clause below). 
                        		
                        		<br/><br/>In consideration of the forgoing terms, it is understood that <strong> Excel Investigations shall use it best efforts to investigate the matters set forth and perform the services for which it is being retained. Excel shall explore all lawful means to assure the best performance and results and to do all necessary, appropriate or advisable in performing said services.  Excel promises to provide all proof of services which may include any of the Following: ( Proof of service, written reports, statements, video documentation, photographs, information services reports, etc….) to guarantee our thorough and sincere efforts. Excel promise to provide a detailed invoice that outlines all expenses or your money back guarantee…!</strong> It is understood that not all results can be guaranteed, compensation to Excel Investigation shall not be based on results. <strong>This Clause is exempt if Client is under the “Guarantee” Process services agreement </strong> 
                        		 
                        		 
                        		 <br/><br/><strong>In the Event that Excel Investigation is unable or unsuccessful to obtain any information or unable to provide proof of service a complete refund will be issued. </strong>However out-of-pocket expenses, travel time and information service costs shall not be refunded.
                        		 
                        		 <br/><br/><strong>Excel Investigations agrees to conduct this investigation with due diligence to protect the interests of CLIENT, and agrees that whatever confidential information is obtained while conducting the Process Service, will only be given to CLIENT and further agrees to restrict the dissemination of said findings to any third party.</strong>
                        		
                        		
                        		<br/><br/>No service shall be rendered by Excel Investigations to CLIENT until such time as the retainer has been paid and this retainer agreement signed. A copy or fax of the retainer agreement will be valid as an original.
                        		
                        		 <br/><br/>Any amounts or expenses incurred above the retainer fee of $_250.00____ shall be due payable immediately upon notice. In the event of default in payment of sums due hereunder and if the agreement is placed in the hand of an attorney at law, small claims, or collection including time spent in court, at the same rate per hour agreed. This includes but not limited to any reasonable attorney’s fees. Payments arriving after the due date will be considered late and a service charge of 1.5% per month (compounded monthly) of the balance due will be charged to the client. Client consents to collection jurisdiction in the state, or county of Excel Investigation’s Choice.
                        		  ...
                        		  <br/><br/><strong>Excel Investigations</strong> reserves the right to withhold the release of Proof of service which it develops during the course of the service in the event the CLIENT has failed to pay for services rendered and costs incurred.
                        		 ...
                        		 <br/><br/>In the event that CLIENT terminates this agreement, CLIENT agrees that the retainer paid to Excel Investigation shall remain the property of Excel investigation and shall be forfeited by CLIENT. CLIENT further agrees to pay promptly in full all fees for additional services, expenses, mileage or other costs, which exceed the amount of the retainer. Any balance of retainer not used by CLIENT will be applied to future investigations required b the client for a period of five years.
                        		  
                        		  <br/><br/>Excel Investigations does not warrant or guarantee the accuracy or completeness of any information used in the preparation of its reports, CLIENT further agrees to defend, indemnify and hold EXCEL INVESTIGATIONS and/or its agents, associates, and employees harmless from any and all action, courses of action, claims, damages and demands of whatever type arising directly or indirectly from the services EXCEL INVESTIGATIONS are being retained to perform pursuant to this agreement.
